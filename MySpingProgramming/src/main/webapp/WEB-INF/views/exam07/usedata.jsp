...
<%@ page import= "com.mycompany.myapp1.exam07.*"%>
...
<html>
	...
	<body>
		...
		<table style="border-collapse: collapse; border: 1px solid black; width: 600px">
			...
			<%for(Board b : list) {%>
				<tr>
					<td style="border: 1px solid black;">번호: <%=b.getBno() %> </td>
					<td style="border: 1px solid black;">제목: <%=b.getTitle() %> </td>
					<td style="border: 1px solid black;">내용: <%=b.getContent() %> </td>
