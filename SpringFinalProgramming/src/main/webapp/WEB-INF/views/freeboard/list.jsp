	...
	<body>
		...
		<table style="border-collapse: collapse; border: 1px solid black; width: 600px">
			...
			<c:forEach var="board" items="${list}">
				<tr>
					<td style="border: 1px solid black;">${board.bno}</td>
					<td style="border: 1px solid black;">
						<a href="info?bno=${board.bno}">${board.btitle}</a>
					</td>
					<td style="border: 1px solid black;">${board.bwriter}</td>
					<td style="border: 1px solid black;">${board.bhitcount}</td>
					<td style="border: 1px solid black;">${board.bdate}</td>
				</tr>
			</c:forEach>
		</table>
